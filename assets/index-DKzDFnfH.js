...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ga,depthTest:!1,depthWrite:!1})}function mb(o,t,i){const s=new Float32Array(ws),l=new K(0,1,0);return new ki({name:"SphericalGaussianBlur",defines:{n:ws,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${o}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:tu(),fragmentShader:`
		...
		`,blending:ga,depthTest:!1,depthWrite:!1})}function E0(){return new ki({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:tu(),fragmentShader:`
		...
		`,blending:ga,depthTest:!1,depthWrite:!1})}function T0(){return new ki({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:tu(),fragmentShader:`
...
#define LOW_PRECISION`),t}const UA={[Bc]:"SHADOWMAP_TYPE_PCF",[Xo]:"SHADOWMAP_TYPE_VSM"};function LA(o){return UA[o.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const NA={[Ns]:"ENVMAP_TYPE_CUBE",[Ir]:"ENVMAP_TYPE_CUBE",[Qc]:"ENVMAP_TYPE_CUBE_UV"};function OA(o){return o.envMap===!1?"ENVMAP_TYPE_CUBE":NA[o.envMapMode]||"ENVMAP_TYPE_CUBE"}const PA={[Ir]:"ENVMAP_MODE_REFRACTION"};function FA(o){return o.envMap===!1?"ENVMAP_MODE_REFLECTION":PA[o.envMapMode]||"ENVMAP_MODE_REFLECTION"}const IA={[k0]:"ENVMAP_BLENDING_MULTIPLY",[lM]:"ENVMAP_BLENDING_MIX",[cM]:"ENVMAP_BLENDING_ADD"};function zA(o){return o.envMap===!1?"ENVMAP_BLENDING_NONE":IA[o.combine]||"ENVMAP_BLENDING_NONE"}function BA(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,s=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:s,maxMip:i}}function HA(o,t,i,s){const l=o.getContext(),c=i.defines;let h=i.vertexShader,p=i.fragmentShader;const m=LA(i),d=OA(i),v=FA(i),S=zA(i),g=BA(i),y=EA(i),T=TA(c),C=l.createProgram();let M,x,D=i.glslVersion?"#version "+i.glslVersion+`
